...
//        this.aq(h,15, {ah:[field.value,field.value]}, function (data, textStatus, jqXHR) {
    ...
    login: function(o) {
        ...
        var err_html = function(msg) { return '<img src="'+BR._api.get_host('cdn')+'/cdn/v1/c/img/x-issue.png" alt="" border="0"> <span class="val_err">'+msg+'</span>'; }
        var ok_html = function(msg) { return '<img src="'+BR._api.get_host('cdn')+'/cdn/v1/c/img/check.png" alt="" border="0">'+msg; }
        var h = $.extend({
            clearInfo: function(field){ foa(field).html(''); $(field).data('cs_invalid',false); },
